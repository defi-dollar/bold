...
> = {
  "USDFI-BOLD": {
    ...
    lpToken: "0x791341bd3739Ba8A3DDE41e9411689A1e453FB71",
    rewardToken: "0x6440f144b7e50D6a8439336510312d2F54beB01D", // TODO: Update to actual data
    curvePoolId: "factory-stable-ng-524",
    curvePoolUrl:
      "https://www.curve.finance/dex/ethereum/pools/factory-stable-ng-524/deposit/",
  },
  "USDFI-frxUSD": {
    ...
    curvePoolUrl:
      "https://www.curve.finance/dex/ethereum/pools/factory-stable-ng-527/deposit/",
  },
};
...
// TODO: Update to actual data
export const POOL2_CONFIGS: Record<
  string,
  {
    poolName: string;
    lpTokenSymbol: TokenSymbol;
...
> = {
  "DEFI-WETH": {
    ...
    uniswapPoolUrl:
      "https://app.uniswap.org/explore/pools/unichain/0x3258f413c7a88cda2fa8709a589d221a80f6574f63df5a5b6774485d8acc39d9",
  },
};
...
export const DEFAULT_COMMIT_URL =
