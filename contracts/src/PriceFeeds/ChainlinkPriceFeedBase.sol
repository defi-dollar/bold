...
abstract contract ChainlinkPriceFeedBase is IChainlinkPriceFeed {
    ...
    function _getOracleAnswer(
        ...
        if (
            !_isValidChainlinkPrice(
                chainlinkResponse,
                _oracle.stalenessThreshold
            )
        ) {
            oracleIsDown = true;
        } else {
            scaledPrice = _scaleChainlinkPriceTo18decimals(
    ...
    function _isValidChainlinkPrice(
        ...
        return
            ...
            block.timestamp - chainlinkResponse.timestamp <
            _stalenessThreshold &&
    ...
    function _scaleChainlinkPriceTo18decimals(
        int256 _price,
        uint256 _decimals
